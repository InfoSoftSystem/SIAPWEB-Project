...
public class EmpresaDaoImpl extends XJdbcTemplate implements EmpresaDao {
    ...
    public int create() {
        /*KeyHolder keyHolder = new GeneratedKeyHolder();
         ...
         PreparedStatement ps = cnctn.prepareStatement(getEmpresa().generarInsertSQL(), Statement.RETURN_GENERATED_KEYS);
         ps = JsfUtil.setValuesPreparedStatement(ps, getEmpresa().getDatosInsert());
         return ps;
         }
         }, keyHolder);
         Integer idEmpresa = keyHolder.getKey().intValue();*/
